 ...
 *  under the License.
 *
 *  Version: $Id: Ini.h 42 2012-01-04 12:14:54Z thiadmer.riemersma $
 */
#ifndef INI_H
#define INI_H
...
int  ini_browse(INI_CALLBACK Callback, const void *UserData, const TCHAR *Filename);
  ...
  /* The C++ class in Ini.h was contributed by Steven Van Ingelgem. */
  class Ini
  {
  public:
    Ini(const std::string& filename) : iniFilename(filename)
      { }
